...
class DataLoading:
    ...
    def load_data(self):
        ...
        train_set = torchvision.datasets.ImageFolder(root=r"D:\Studium\3. Semster\Bildanalyse\Assignments\4\Assignment Aufgabe\crop_images\train",
        ...
        test_set = torchvision.datasets.ImageFolder(root=r"D:\Studium\3. Semster\Bildanalyse\Assignments\4\Assignment Aufgabe\crop_images\test",
                                                    transform=torchvision.transforms.Compose(
                                                        [torchvision.transforms.ToTensor(),
                                                         torchvision.transforms.Resize((224, 224)),
                                                         torchvision.transforms.Normalize((0.5, 0.5, 0.5),
